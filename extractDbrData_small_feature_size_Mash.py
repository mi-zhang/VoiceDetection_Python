...
def handleDbrFile(filename, filedir):    
    ...
    # for audio data
        ...
        if row[1] == 0: # write the audio data
            ...
            inferencedata = "" + str(timestamp) + "," + str(row[4]) + "," + str(numAcorrPeaks) + "," + maxAcorrPeakVal + "," + rel_spectral_entropy + "," +  emissionProbabilitiesUnvoiced + "," + emissionProbabilitiesVoiced + "," + str(inferenceArray)[1:-1].replace(" ", "")
...
if __name__ == "__main__":
    ...
    handleDbrFile('1396503646_358239058727449.dbr', './')
